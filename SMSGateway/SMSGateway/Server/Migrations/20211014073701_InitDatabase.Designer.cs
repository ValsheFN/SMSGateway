...
namespace SMSGateway.Server.Migrations
{
    ...
    [Migration("20211014073701_InitDatabase")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SMSGateway.Server.Models.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("SMSGateway.Server.Models.Models.Contact", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("SMSGateway.Server.Models.Models.ContactGroup", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("SMSGateway.Server.Models.Models.Group", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("SMSGateway.Server.Models.Models.Log", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("SMSGateway.Server.Models.Models.SmsTemplate", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("SMSGateway.Server.Models.Models.TopUp", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("SMSGateway.Server.Models.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SMSGateway.Server.Models.Models.Contact", b =>
                {
                    b.HasOne("SMSGateway.Server.Models.Models.ApplicationUser", "CreatedByUser")
                        .WithMany("CreatedContact")
                        .HasForeignKey("CreatedByUserId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("SMSGateway.Server.Models.Models.ApplicationUser", "UpdatedByUser")
